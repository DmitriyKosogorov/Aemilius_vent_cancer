...
#COLOR_ERRONEOUS = ('black', 'black', 'black', 'black', 'black')  # default color for erroneous state
...
FONT_SIZE_BN = 20  # block name font size
FONT_SIZE_PL = 14  # port label font size
  ...
  def __repr__(self):
    ...
    txt += '; number of inputs = {0}; inputs = {1}; number of outputs = {2}; outputs = {3};'\
           'function file = {4}; function name = {5}'.format(self.__no_input, self.__no_output,
                            self.__no_output, self.function[0], self.function[1]) # generate formatted text
    '''
    txt += '; number of inputs = {0}; inputs = {1}; number of outputs = {2}; outputs = {3};'\
           'function file = {4}; function name = {5}'.format(self.__no_input, self.__no_output,
                            self.__no_output,self.outPort(), self.function[0], self.function[1]) # generate formatted text
    return txt
  # } __repr__ func
